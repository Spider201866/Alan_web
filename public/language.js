export const translations = {
  en: {
    ...
    alanMistakes: "Alan can make mistakes. Use clinical judgement. 6/24",
    login: "Login",
  ...
  fr: {
    ...
    alanMistakes:
      "Alan peut se tromper. Utilisez votre jugement clinique. 6/24",
    login: "Connexion",
  ...
  es: {
    ...
    alanMistakes: "Alan puede cometer errores. Usa el juicio clínico. 6/24",
  ...
  pt: {
    ...
    alanMistakes: "Alan pode cometer erros. Use o julgamento clínico. 6/24",
    login: "Entrar",
  ...
  sw: {
    ...
    alanMistakes: "Alan anaweza kukosea. Tumia hukumu ya kliniki. 6/24",
    login: "Ingia",
  ...
  ny: {
    ...
    alanMistakes:
      "Alan angalakwitse. Gwiritsani ntchito chiweruzo cha zamankhwala. 6/24",
    login: "Lowani",
  ...
  rw: {
    ...
    alanMistakes: "Alan ashobora gukosa. Koresha ubushishozi bw'ubuvuzi. 6/24",
    login: "Injira",
  ...
  lg: {
    ...
    alanMistakes:
      "Alan ayinza okukola ensobi. Kozesa okusalirira okw'ekinnansi. 6/24",
    login: "Yingira",
  ...
  cy: {
    ...
    alanMistakes:
      "Gall Alan wneud camgymeriadau. Defnyddiwch farn glinigol. 6/24",
    login: "Mewngofnodi",
