...
!(function (t, e) {
  ...
  var e = {
      ...
      addEventParent: function (t) {
        return (
          (this._eventParents = this._eventParents || {}), (this._eventParents[h(t)] = t), this
        );
      },
  ...
  at.prototype = {
    ...
    _transform: function (t, e) {
      return (
        (t.x = (e = e || 1) * (this._a * t.x + this._b)), (t.y = e * (this._c * t.y + this._d)), t
      );
    },
  ...
  function Ie(t) {
    return (
      S(t, 'mousedown touchstart dblclick contextmenu', Ae), (t._leaflet_disable_click = !0), this
    );
  }
  function O(t) {
    ...
    Ve =
      ...
      B.extend({
        ...
        removeLayer: function (t) {
          ...
          return (
            t && this._layers.splice(this._layers.indexOf(t), 1), this._map ? this._update() : this
          );
        },
        expand: function () {
  ...
  var Ai = o.extend({
      ...
      openOn: function (t) {
        return (
          (t = arguments.length ? t : this._source._map).hasLayer(this) || t.addLayer(this), this
        );
      },
      close: function () {
